...
var presets = []preset{
	...
	{"nord", Theme{Primary: "#88c0d0", Accent: "#8fbcbb", Green: "#a3be8c", Dim: "#4c566a", Err: "#bf616a", Gold: "#ebcb8b", Border: "#434c5e", SelBg: "#3b4252", Text: "#d8dee9", Subtle: "#616e88", HostTag: "#b48ead", Bg: "#2e3440"}},
	...
	{"solarized-dark", Theme{Primary: "#268bd2", Accent: "#2aa198", Green: "#859900", Dim: "#586e75", Err: "#dc322f", Gold: "#b58900", Border: "#073642", SelBg: "#073642", Text: "#93a1a1", Subtle: "#657b83", HostTag: "#6c71c4", Bg: "#002b36"}},
	{"solarized-light", Theme{Primary: "#268bd2", Accent: "#2aa198", Green: "#859900", Dim: "#93a1a1", Err: "#dc322f", Gold: "#b58900", Border: "#eee8d5", SelBg: "#eee8d5", Text: "#586e75", Subtle: "#657b83", HostTag: "#6c71c4", Bg: "#fdf6e3"}},
	...
	{"catppuccin-frappe", Theme{Primary: "#f4b8e4", Accent: "#99d1db", Green: "#a6d189", Dim: "#737994", Err: "#e78284", Gold: "#e5c890", Border: "#51576d", SelBg: "#414559", Text: "#c6d0f5", Subtle: "#838ba7", HostTag: "#ca9ee6", Bg: "#303446"}},
	{"catppuccin-latte", Theme{Primary: "#ea76cb", Accent: "#209fb5", Green: "#40a02b", Dim: "#8c8fa1", Err: "#d20f39", Gold: "#df8e1d", Border: "#ccd0da", SelBg: "#dce0e8", Text: "#4c4f69", Subtle: "#6c6f85", HostTag: "#8839ef", Bg: "#eff1f5"}},

	{"tokyonight", Theme{Primary: "#7aa2f7", Accent: "#7dcfff", Green: "#9ece6a", Dim: "#565f89", Err: "#f7768e", Gold: "#e0af68", Border: "#3b4261", SelBg: "#292e42", Text: "#c0caf5", Subtle: "#565f89", HostTag: "#bb9af7", Bg: "#1a1b26"}},
	{"tokyonight-storm", Theme{Primary: "#7aa2f7", Accent: "#7dcfff", Green: "#9ece6a", Dim: "#565f89", Err: "#f7768e", Gold: "#e0af68", Border: "#3b4261", SelBg: "#2d3149", Text: "#c0caf5", Subtle: "#565f89", HostTag: "#bb9af7", Bg: "#24283b"}},
	{"tokyonight-day", Theme{Primary: "#2e7de9", Accent: "#007197", Green: "#587539", Dim: "#848cb5", Err: "#f52a65", Gold: "#8c6c3e", Border: "#c4c8da", SelBg: "#c4c8da", Text: "#3760bf", Subtle: "#6172b0", HostTag: "#9854f1", Bg: "#e1e2e7"}},
}
