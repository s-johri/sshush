...
| 9 | Hot reload (fsnotify), reconcile | medium |
| 10 | App config (~/.config/sshush), default identity | low |
| 11 | Shell startup snippet generator (print only) | low |
| 12 | lipgloss styling pass | none |
